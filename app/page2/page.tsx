  ...
  return (
    <div className="w-full max-w-screen mx-auto py-4 px-0 sm:px-8 md:py-10">
      <div className="bg-white/80 rounded-2xl shadow-lg p-4 sm:p-8 space-y-6 sm:space-y-8 border border-gray-100">
        ...
        <h1 className="text-2xl sm:text-4xl font-extrabold text-gray-900 mb-2 leading-tight text-center">Was het verzet van Dario Amodei tegen minister Hegseth het “Ik ben Spartacus!”-moment van Silicon Valley?</h1>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mt-6 sm:mt-8 justify-center">
          <Button variant="outline" className="rounded-full px-4 sm:px-6 py-2 text-xs sm:text-sm font-semibold">Cultuur en media</Button>
          <Button variant="outline" className="rounded-full px-4 sm:px-6 py-2 text-xs sm:text-sm font-semibold">De Technocraat</Button>
          <Button variant="outline" className="rounded-full px-4 sm:px-6 py-2 text-xs sm:text-sm font-semibold">Artificiële intelligentie</Button>
        </div>
      </div>
    </div>
  )
